            ...
            <div className="container-techs">
                ...
                <div className="container-icons">
                    ...
                    <div className="first-group">
                        ...
                        <SiExpo
                            className='techs-icon'
                            onMouseEnter={() => setHover('Desenvolvimento de aplicativos com Expo utilizando React native.')}
                            onMouseLeave={() => setHover('')}
                        />
                        <TbBrandTypescript 
                            className='techs-icon'
                            onMouseEnter={() => setHover('Aplicações feitas em Typescript para organização do código.')}
                            onMouseLeave={() => setHover('')}
                        />
                    </div>
